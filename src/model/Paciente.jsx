...
renderAcciones = (rowData) => {
    ...
    render() {
        ...
        const dataForDataTable = this.state.paciente.map((paciente, index) => {
        ...
        return (
            <>
                <div className="card2">
                    ...
                    globalFilterFields={['obra_social', 'pais', 'provincia', 'formattedDate', 'localidad', "direccion"]} header={header} emptyMessage="Nada Encontrado" tableStyle={{ minWidth: '50rem' }}>
                        <Column field="obra_social" header="obra_social" sortable style={{ width: '10%' }}></Column>
                        <Column field="pais" header="pais" sortable style={{ width: '10%' }}></Column>
                        <Column field="provincia" header="provincia" sortable style={{ width: '10%' }}></Column>
                        <Column field="formattedDate" header="Fecha de Nacimiento" sortable style={{ width: '10%' }}></Column>
                        <Column field="localidad" header="localidad" sortable style={{ width: '10%' }}></Column>
                        <Column field="direccion" header="direccion" sortable style={{ width: '10%' }}></Column>
