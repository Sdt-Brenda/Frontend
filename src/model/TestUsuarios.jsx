...
class AdvancedFilterDemo extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div className="justify-content: center;">
                ...
                <span className="p-input-icon-left">
                    ...
                    <InputText value={this.state.globalFilterValue} onChange={this.onGlobalFilterChange} placeholder="Busqueda" />
                </span>
            </div>
        );
    }
    ...
    render() {
        ...
        return (
            <>
            <div className="card2">
                <DataTable value={dataForDataTable} paginator showGridlines rows={10} dataKey="id" filters={this.state.filters} 
                globalFilterFields={['nombre', 'apellido', 'dni', 'formattedDate', 'genero', "email", "rol","id_usuario"]} header={header} emptyMessage="Nada Encontrado" tableStyle={{ minWidth: '50rem' }}>
                    <Column field="nombre" header="Nombre" filter filterPlaceholder="Search by name" filterMatchMode="contains" style={{ width: '20%' }} />
                    <Column field="apellido" header="Apellido" style={{ width: '20%' }}/>
                    <Column field="dni" header="Dni" style={{ width: '20%' }}/>
                    <Column field="formattedDate" header="Fecha de Nacimiento" dataType="date" style={{ width: '20%' }}/>
                    <Column field="genero" header="Genero" dataType="numeric" style={{ width: '20%' }}/>
                    <Column field="email" header="Email" style={{ width: '20%' }}/>
                    <Column field="rol" header="Rol" style={{ width: '20%' }}/>
                    <Column field="id_usuario" header="ID Usuario" style={{ width: '20%' }}/>
            ...
            <Modal show={this.state.modal} onHide={this.closeModal}>
                    ...
                    <Modal.Footer>
                        <Button variant="danger" severity="danger" onClick={() => this.handleClickDelete()}>
                            Eliminar
                        </Button>
